...
$menuItems = [
    ...
    [
        "menuTitle" => "Histórico precios",
        "icon" => "fas fa-history",
        "pages" => [
            ["title" => "Histórico precios", "url" => "historico_precios.php"]
        ],
    ],
    [
        "menuTitle" => "Lista de precios",
        "icon" => "fas fa-list",
        "pages" => [
            ["title" => "Lista de precios", "url" => "lista_precios.php"]
        ],
    ],
    [
        "menuTitle" => "Permisos - Roles",
        "icon" => "fas fa-user-shield",
        "pages" => [
            ["title" => "Permisos - Roles", "url" => "permisos_roles.php"]
        ],
    ]
];
...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="./" class="brand-link d-flex align-items-center" style="gap:10px;">
                <img src="src/images/logo.png"
                     alt="Logo Assa Abloy"
                     class="brand-image img-circle bg-white"
            ...
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex align-items-center">
                    ...
                    <div class="info">
                        <a href="perfil.php" class="d-block fw-bold">Alejandra Molina</a>
                    </div>
                </div>
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" role="menu">
                        <?php foreach ($menuItems as $menuItem): ?>
                            <li class="nav-item">
                                <a class="nav-link <?= $menuItem === $active_menu ? 'active' : '' ?>" href="<?= $menuItem['pages'][0]['url'] ?>">
